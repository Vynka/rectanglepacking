...
public class Solution {
	 ...
	 * N de rectangulos siempre devolvera la misma solucion inicial. Ordenado por Tama�o de areas
	 * @param size
	 * 			numero de rectangulos (Tamano de la solucion)
	 */
	...
	/**
	 * Inicializa de una manera concreta una solucion. Para el mismo conjunto
	 * N de rectangulos siempre devolvera la misma solucion inicial. Uno Grande uno peque�o
	 * @param size
	 * 			numero de rectangulos (Tamano de la solucion)
	 */
